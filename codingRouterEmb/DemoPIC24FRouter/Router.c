                ...
                switch (params.APSDE_DATA_indication.DstEndpoint)
                {
                    ...
                    case WSAN_Dst:
                    {
                        switch(params.APSDE_DATA_indication.ClusterId.Val)
                        {
                            ...
                            case RELAY_RESPONSE:// STATUS RELAY REMOTE
                            {
                                printf ("#RS:");
                                PrintWord(params.APSDE_DATA_indication.SrcAddress.ShortAddr.Val);
                                PrintChar(APLGet());//Byte0 dia chi MAC
                            ...
                            case HTE_RESPONSE_CLUSTER://7
                                ...
                                break;
                            case MAX_RESPONSE_CLUSTER://7
                                {
                                    printf("#AS:");
                                    PrintWord(params.APSDE_DATA_indication.SrcAddress.ShortAddr.Val);
                                    PrintChar(APLGet());//Byte0 dia chi MAC
                                    PrintChar(APLGet());//anhsang
                                    PrintChar(APLGet());                                   
                                    printf("\r\n");
                                    #if defined(USE_LED)
                                        WSAN_LED = ~WSAN_LED;
                            ...
                            case HTE_AUTO_SEND_CLUSTER://8
                                ...
                                break;
                                case CMR_AUTO_SEND_CLUSTER://12
                                {
                                    printf("#RA:");// khai bao moi
                                    PrintWord(params.APSDE_DATA_indication.SrcAddress.ShortAddr.Val);
                                    PrintChar(APLGet());//Byte0 dia chi MAC
                                    PrintChar(APLGet());//2 byte do dai anh
                                    PrintChar(APLGet());
                        ...
                        if ((Addr_MSB == 0xff)&&(Addr_LSB == 0xff))
                        {
                            ...
                            switch (ServiceCmd)
                            {
                                ...
                                case 0x30:
                                    ...
                                    break;
                                case 0x60:
                                    SendOneByte(MAX_REQUEST_CLUSTER, Addr_MSB, Addr_LSB, ContentCmd);
                                    EnableSendCmd = CLEAR;
                                    break;
                        ...
                        else
                        {
                            switch(Cmd)
                            {
                                ...
                                case 0x58://lay thong tin node mang
                                    ...
                                    break;
                                case 0x60:
                                    SendOneByte(MAX_REQUEST_CLUSTER, Addr_MSB,Addr_LSB,Cmd);//Lay gia tri anh sang
                                    break;
                                case 0x61:
                                    SendOneByte(RELAY_FUNCTION, Addr_MSB,Addr_LSB,Cmd);//ON BOM
                                    break;
                                case 0x62:
                                    SendOneByte(RELAY_FUNCTION, Addr_MSB,Addr_LSB,Cmd);//OFF BOM
                                    break;
                                case 0x63:
                                    SendOneByte(RELAY_FUNCTION, Addr_MSB,Addr_LSB,Cmd);//ON LIGHT
                                    break;                                                                        
                                case 0x64:
                                    SendOneByte(RELAY_FUNCTION, Addr_MSB,Addr_LSB,Cmd);//OFF LIGHT
                                    break;                                    
                                ////////////////////////////////////////////////   
